...
export const blogPosts = [
  {
    ...
    excerpt: 'Discover the essential practices that will elevate your web development projects in 2025.',
  ...
  },
  {
    ...
    excerpt: 'Explore how artificial intelligence is revolutionizing mobile app development and user experiences.',
    category: 'AI/ML',
    readTime: '12 min',
    author: 'AppDost Team',
    date: 'Jan 10, 2025',
  ...
  },
  {
    ...
    excerpt: 'Stay ahead of the curve with these emerging design trends that are shaping the digital landscape.',
    category: 'Design',
    readTime: '10 min',
    author: 'AppDost Team',
    date: 'Jan 5, 2025',
...
export const careersData = [
  ...
  },
  {
    ...
    department: 'Design',
    description: 'Join our creative team as a UI/UX Designer and help us create beautiful, intuitive user experiences for our clients.',
    requirements: [
  ...
  },
  {
    ...
    department: 'Engineering',
    description: 'We are seeking a talented Android Developer to create innovative mobile applications for our clients.',
    requirements: [
  ...
  },
  {
    ...
    location: 'Banka, India',
    type: 'Full-time',
    experience: '3-5 years',
    department: 'Operations',
    description: 'Looking for a skilled DevOps Engineer to manage our infrastructure and deployment processes.',
    requirements: [
...
export const whyChooseUs = [
  ...
  { title: 'Agile Development Process', description: 'Fast iterations, continuous feedback, rapid delivery' },
...
export const workCulture = [
  { icon: 'Target', title: 'Innovation First', description: 'Encouraging creative problem-solving' },
  ...
  { icon: 'Scale', title: 'Work-Life Balance', description: 'Flexible arrangements' },
